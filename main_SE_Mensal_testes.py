...
if __name__ == "__main__":
    ...
    PROJETO = 'PB - FAFEN O&M SE - OS 177/25'
    SAIDA = r'C:\Users\operacoes\OneDrive - ENGEMAN\01-(MATRIZ) SETOR DE OPERAÇÕES - Documentos\01. MATRIZ - RECIFE\CONTROLADORIA\Controle de Mobilizações\Fafen\Controle Fafen Oficial\testes\Dados_FAFEN_SE_Mensal_testes.xlsx'
