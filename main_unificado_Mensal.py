...
ITENS_PARA_FILTRAR = ['Item Atendido', 'Item em Aberto', 'Aprovar Alçada']
...
if __name__ == "__main__":
    ...
    SAIDA = r'C:\Users\operacoes\OneDrive - ENGEMAN\01-(MATRIZ) SETOR DE OPERAÇÕES - Documentos\01. MATRIZ - RECIFE\CONTROLADORIA\Controle de Mobilizações\Fafen\Controle Fafen Oficial\Resumo_Mensal_FAFENS_BA_SE.xlsx'
